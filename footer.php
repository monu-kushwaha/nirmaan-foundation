                        ...
                        <div class="footer__newsletter-check">
                           <div class="form-group">
                              ...
                              <label for="acceptPolicy">By subscribing, you're accepting our <a
                                    href="contact-us.php">Privacy Policy</a></label>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-12 col-md-6 col-xl-2 offset-xl-1">
                     <div class="footer__list" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                        ...
                        <div class="footer__list-items">
                           <ul>
                              <li><a href="about-us.php"><i class="fa-solid fa-angles-right"></i>About Us</a>
                              </li>
                              <li><a href="our-causes.php"><i class="fa-solid fa-angles-right"></i>Our
                                    Causes</a>
                              </li>
                              <li><a href="our-team.php"><i class="fa-solid fa-angles-right"></i>Our
                                    Teams</a>
                              </li>
                              <li><a href="blog-list.php"><i class="fa-solid fa-angles-right"></i>Our
                                    Blog</a>
                              </li>
                              <li><a href="faq.php"><i class="fa-solid fa-angles-right"></i>FAQ</a></li>
                              <li><a href="contact-us.php"><i class="fa-solid fa-angles-right"></i>Get A
                                    Quote</a>
                              </li>
                           </ul>
                        </div>
                  ...
                  <div class="col-12 col-md-6 col-xl-3">
                     <div class="footer__list" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                        <div class="footer__list-group">
                           ...
                           <div class="content">
                              <p>
                                 <a href="https://maps.app.goo.gl/XGZbdeApp3x1g7Qw8" target="_blank">5Mehna Basti street no 2 (Bathinda)
                                 </a>
                              </p>
                           </div>
                        </div>
                        <div class="footer__list-group">
                           ...
                           <div class="content">
                              <p>
                                 <a href="mailto:NirmaanFoundation@gmail.com">NirmaanFoundation@gmail.com</a>
                              </p>
                              <p><a href="tel:9115866279"> 9115866279 </a>
                              </p>
                           </div>
                        </div>
                     </div>
                              ...
                              <div class="row align-items-center gutter-24">
                                 ...
                                 <div class="col-12 col-xl-6">
                                    <div class="footer__bottom-right text-center">
                                       <p>Copyright &copy; <span id="copyrightYear"></span> <a href="index.php"
                                             target="_blank">Charifund</a>. All rights
                                          reserved.
                                       </p>
                                    </div>
                                 </div>
